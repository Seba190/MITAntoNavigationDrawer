...
import com.seba.mitantonavigationdrawer.ui.Formularios.añadirAlmacen.añadirTransferencia.AnadirTransferenciaViewHolder
import com.seba.mitantonavigationdrawer.ui.SharedViewModel

class EditarTransferenciaAdapter (var listaDeCantidades: MutableList<String>
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): AnadirTransferenciaViewHolder {
        val v = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_elegir_producto, parent, false)
